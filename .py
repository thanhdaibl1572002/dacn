...
# Hàm chuyển đổi file CSV thành số nguyên
def convert_to_integers(file_path, output_path):
    # Đọc file CSV
    df = pd.read_csv(file_path)
    
    # Chuyển tất cả giá trị thành số nguyên
...
files = {
    "classification_big.csv": "classification_big.csv",
    "classification_medium.csv": "classification_medium.csv",
    "classification_small.csv": "classification_small.csv"
}

# Chuyển đổi và lưu các file
for input_file, output_file in files.items():
    convert_to_integers(input_file, output_file)
